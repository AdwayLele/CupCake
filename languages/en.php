...
$lang = array_merge($lang,array(
	...
	"ACCOUNT_ACTIVATION_COMPLETE"		=> "You have successfully activated your account. You can now login <a href=".str_replace('index.php/', '', site_url('login')).">here</a>.",
	"ACCOUNT_REGISTRATION_COMPLETE_TYPE1"	=> "You have successfully registered. You can now login <a href=".str_replace('index.php/', '', site_url('login')).">here</a>.",
	...
	"NO_SELECTION_TO_DELETE_USER"  => "Please select a user to delete",
	...
	"NO_PERMISSION_SELECTED"	=> "Please add a new permission or select one to delete",
	"PAGE_VALIDATION_ERROR"	=>	"Please enter valid page name",
	"PAGE_CREATED_SUCCESSFULLY"	=>	"<h3>Your newly created pages are available at following address:</h3><br/>
										<h4>If you want to change your controller file, please go at this address</h4>
										%m1%/application/controllers/%m2%.php<br/><br/>
										<h4>If you want to change your view file, please go at this address</h4>
										%m1%/application/views/%m2%.php<br/>",
	"USER_CREATED_PAGE_EXIST"	=>	"Please select some other name, this name is already in use",
